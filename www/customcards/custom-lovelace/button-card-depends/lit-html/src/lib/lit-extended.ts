...
import {AttributePart, defaultPartCallback, noChange, getValue, Part, SVGTemplateResult, TemplateInstance, TemplatePart, TemplateResult} from '/local/button-card-depends/lit-html/lit-html.js';

export {render} from '/local/button-card-depends/lit-html/lit-html.js';
 ...
 * /local/button-card-depends/lit-html templates preserve case, so properties are case sensitive. If an
