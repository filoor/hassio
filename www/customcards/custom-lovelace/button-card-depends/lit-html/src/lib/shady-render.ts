...
import {removeNodes, Template, templateCaches, TemplateContainer, TemplateInstance, TemplateResult} from '/local/button-card-depends/lit-html/lit-html.js';

import {insertNodeIntoTemplate, removeNodesFromTemplate} from './modify-template.js';

export {html, svg, TemplateResult} from '/local/button-card-depends/lit-html/lit-html.js';
 ...
 * (2) removes style elements from all /local/button-card-depends/lit-html Templates for this scope name.
 *
...
// NOTE: We're copying code from /local/button-card-depends/lit-html's `render` method here.
